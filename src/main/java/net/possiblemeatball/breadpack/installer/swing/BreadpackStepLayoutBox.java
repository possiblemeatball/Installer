...
public class BreadpackStepLayoutBox extends JComponent {
    private final Font basicFont;
    public BreadpackStepLayoutBox(BreadpackFrame frame) {
        setLayout(null);
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2d.drawString("Steps go here", 8, (2 * (basicFont.getSize2D() / 2)));
    }
